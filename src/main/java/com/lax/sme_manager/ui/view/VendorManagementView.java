...
public class VendorManagementView extends VBox implements RefreshableView {
    ...
    private TableView<VendorEntity> createVendorTable() {
        ...
        actionsCol.setCellFactory(col -> new TableCell<>() {
            ...
            private final Button insightsBtn;
...

            {
                ...
                insightsBtn = createModernActionButton(
                        "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z",
                        "#E0F2FE", "#0284C7", "#BAE6FD", "View Insights");
                ...
                container.getChildren().addAll(insightsBtn, editBtn, deleteBtn);
    ...
    private void handleViewInsights(VendorEntity vendor) {
        VendorInsightsView insights = new VendorInsightsView(vendor.getId(), vendor.getName());
        insights.show();
    }
